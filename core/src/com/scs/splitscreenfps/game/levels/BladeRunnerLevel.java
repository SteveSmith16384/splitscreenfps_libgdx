				...
				for (int col=0 ; col<cells.length ; col++) {
					...
					for (String token : tokens) {
						if (token.equals("S")) { // Start pos
							...
							Floor floor = new Floor(game.ecs, "bladerunner/textures/street001.jpg", col, row, 1, 1, false);
							...
							Floor floor = new Floor(game.ecs, "bladerunner/textures/road2.png", col, row, 1, 1, false);
							game.ecs.addEntity(floor);
						} else {
